INSERT INTO contest_event (old_id, updated, created, updated_by, created_by, name, date_of_event, date_resolution, contest_id, notes, venue_id, complete, no_contest, contest_type_id, original_owner)
  VALUES (
    {{ContestEvent.id}},
    ...
    '{{ContestEvent.lastChangedBy.username}}',
...
INSERT INTO contest_event_test_piece (updated, created, updated_by, created_by, contest_event_id, piece_id, and_or)
VALUES (
    CONVERT(datetime, '{{ContestEvent.last_modified|date:"Y-m-d H:i:s"}}', 20),
    CONVERT(datetime, '{{ContestEvent.created|date:"Y-m-d H:i:s"}}', 20),
    '{{ContestEvent.owner.username}}',
...
INSERT INTO contest_result (old_id, updated, created, updated_by, created_by, contest_event_id, band_id, band_name, result_position_type, result_position, draw, draw_second, 
...
{% endif %}
  ...
  '{{result.conductor_name_export|safe}}',
...
INSERT INTO contest_result_test_piece (updated, created, updated_by, created_by, contest_result_id, piece_id, ordering, suffix)
VALUES (
  CONVERT(datetime, '{{result.last_modified|date:"Y-m-d H:i:s"}}', 20),
  CONVERT(datetime, '{{result.created|date:"Y-m-d H:i:s"}}', 20),
  '{{result.owner.username}}',
