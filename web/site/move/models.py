...
class BandMergeRequest(models.Model):
    ...
    source_band = models.ForeignKey(Band, related_name='BandFrom', on_delete=models.CASCADE)
    destination_band = models.ForeignKey(Band, related_name='BandTo', on_delete=models.CASCADE)
    lastChangedBy = models.ForeignKey(User, on_delete=models.PROTECT, editable=False, related_name='BandMergeLastChangedBy',blank=True,null=True)
    owner = models.ForeignKey(User, on_delete=models.PROTECT, editable=True, related_name='BandMergeOwner',blank=True,null=True)
