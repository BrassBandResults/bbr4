resource "aws_iam_role" "bbrie-iam-lambda-notify-twitter" {
  name = "bbrie-iam-lambda-notify-twitter"
...
resource "aws_iam_role_policy_attachment" "bbr-lambda-notify-twitter-logs" {
  role = "${aws_iam_role.bbrie-iam-lambda-notify-twitter.name}"
...
resource "aws_lambda_function" "bbr-notify-twitter" {
  ...
  role = "${aws_iam_role.bbrie-iam-lambda-notify-twitter.arn}"
